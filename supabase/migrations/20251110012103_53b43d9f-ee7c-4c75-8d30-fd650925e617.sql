-- =====================================================
-- FIX: Corrigir ordem das operações em approve_video
-- para evitar violação do constraint idx_pedido_videos_one_selected
-- =====================================================
...
BEGIN
  ...
  -- **FIX CRÍTICO**: Desmarcar TODOS os vídeos do pedido PRIMEIRO
  -- para evitar violação do constraint idx_pedido_videos_one_selected
  ...
  -- Agora aprovar e marcar o vídeo (sem conflito de constraint)
  UPDATE pedido_videos 
  SET 
