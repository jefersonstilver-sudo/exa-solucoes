-- =====================================================
-- FIX: Remover INSERT problemático de log_eventos_sistema
-- da função approve_video que estava causando erro RLS
-- =====================================================
...
-- =====================================================
-- FIX: Ajustar RLS de log_eventos_sistema para permitir
-- INSERTs de funções do sistema
-- =====================================================

-- Remover política existente
DROP POLICY IF EXISTS "Admin can access system event logs" ON public.log_eventos_sistema;

-- Criar políticas separadas mais flexíveis
