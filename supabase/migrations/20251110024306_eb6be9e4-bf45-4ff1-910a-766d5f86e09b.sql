-- Corrigir função RPC para usar colunas corretas
...
COMMENT ON FUNCTION get_pedidos_com_status_inteligente() IS 'Retorna pedidos com status calculado dinamicamente baseado no estado dos vídeos. Usa client_id (não user_id) conforme schema correto.';