-- Corrigir função approve_video com search_path correto
...
VALUES ('MIGRATION', 'Corrigido search_path da função approve_video para evitar erro de tabela não encontrada');