-- Reforçar regras de formatação no Knowledge Item "Como Formatar Lista"
UPDATE agent_knowledge_items
SET 
  content = '**Formato de apresentação - OBRIGATÓRIO:**
...
⚠️ CRÍTICO: NUNCA usar ponto como separador de milhares!
✅ CERTO: 14400/mês, 7200/mês, 36000/mês
❌ ERRADO: 14.400/mês, 7.200/mês, 36.000/mês (QUEBRA NO WHATSAPP!)
