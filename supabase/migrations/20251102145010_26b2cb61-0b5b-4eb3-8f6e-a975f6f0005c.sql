-- Remover a expressão de geração da coluna visualizacoes_mes
ALTER TABLE buildings 
ALTER COLUMN visualizacoes_mes DROP EXPRESSION;
...
-- Atualizar todos os prédios existentes com o cálculo
UPDATE buildings
