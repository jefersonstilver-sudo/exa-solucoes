-- =====================================================
-- FIX: Corrigir approve_video para não desmarcar TODOS os vídeos
-- Desmarcar APENAS quando o novo vídeo será o base
-- =====================================================
...
BEGIN
  ...
  -- **FIX CRÍTICO**: Desmarcar outros vídeos base APENAS se este será o base
  ...
  -- Agora aprovar e marcar o vídeo
  UPDATE pedido_videos 
  SET 
...
COMMENT ON FUNCTION public.approve_video(uuid, uuid) IS 
'Aprova um vídeo e define como base APENAS se for o primeiro aprovado ou se não houver outro base ativo.
FIX: Desmarca outros vídeos base SOMENTE quando necessário para evitar conflito com trigger.';