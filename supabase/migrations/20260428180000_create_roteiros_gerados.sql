-- Tabela para armazenar roteiros gerados pelo Gerador de Roteiros EXA
...
-- RLS: cada usuário vê apenas seus próprios roteiros
...
-- Índice para buscar roteiros por usuário ordenados por data
