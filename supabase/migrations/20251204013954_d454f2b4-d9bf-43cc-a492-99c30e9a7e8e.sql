-- 1. Dropar função existente e recriar com client_name corrigido
...
-- 2. Corrigir dados do pedido existente (tipo_pagamento e parcela_atual)
UPDATE pedidos 
SET 
  tipo_pagamento = 'personalizado',
  parcela_atual = 2,
