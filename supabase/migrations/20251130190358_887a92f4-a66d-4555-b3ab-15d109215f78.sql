-- Deletar a seção 6 incorreta e criar a seção 4 correta
DELETE FROM agent_sections WHERE agent_id = '6e0278e4-c95d-4d90-b976-d19c375b644b' AND section_number = 6;

-- Criar seção 4 - Planos e Sistema de Descontos
INSERT INTO agent_sections (agent_id, section_number, section_title, content)
VALUES (
  '6e0278e4-c95d-4d90-b976-d19c375b644b',
  4,
  '💰 PLANOS E SISTEMA DE DESCONTOS',
