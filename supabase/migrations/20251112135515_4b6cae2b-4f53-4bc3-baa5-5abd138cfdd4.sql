-- Recriar a função safe_set_base_video com a ordem correta dos UPDATEs
...
COMMENT ON FUNCTION public.safe_set_base_video IS 'Define um slot como vídeo base principal, garantindo que apenas um base exista por pedido. ORDEM CORRETA: primeiro desmarca outros, depois marca o novo.';