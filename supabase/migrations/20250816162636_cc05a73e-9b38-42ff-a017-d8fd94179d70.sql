-- Create secure function to get approved videos with all details
...
-- Grant execute permission to authenticated users (RLS will handle the actual access control)
GRANT EXECUTE ON FUNCTION public.get_approved_videos_with_details() TO authenticated;