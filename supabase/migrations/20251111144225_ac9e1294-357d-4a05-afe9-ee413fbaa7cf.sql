-- Correção: Remover SET session_replication_role que requer privilégios de superusuário
-- Essa configuração estava impedindo a execução da função
...
BEGIN
  ...
  -- Desativar todas as regras de agendamento do novo vídeo principal
  ...
  -- Reativar agendamentos do vídeo anterior que deixou de ser principal (se houver)
