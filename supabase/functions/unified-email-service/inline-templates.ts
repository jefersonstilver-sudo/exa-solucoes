  ...
  <style>
    ...
    * {
    ...
    @media screen and (max-width: 640px) {
      ...
      .cta-button { width: 100%; padding: 16px 0; }
    }
  </style>
</head>
<body>
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="header">
        ...
        <p class="header-subtitle">Bem-vindo à Publicidade Inteligente</p>
      </div>
      ...
      <div class="content">
        ...
        <p class="message">
          ...
          e gerenciar suas campanhas publicitárias, confirme seu endereço de e-mail clicando abaixo.
        </p>
        ...
        <div class="info-box">
          ...
          <p style="margin-top: 8px;">
            ...
            sobre suas campanhas, além de possibilitar a recuperação de senha quando necessário.
          </p>
        </div>

        <p class="message" style="font-size: 14px; color: #666; margin-bottom: 0;">
      ...
      <div class="footer">
        ...
        <p class="footer-text" style="font-size: 12px; color: #bbb; margin-top: 12px;">
