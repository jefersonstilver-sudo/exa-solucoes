      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">INDEXA</h1>
              <p className="text-xs text-indexa-mint font-semibold">MEDIA</p>
            </div>
          </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center bg-gray-100 rounded-lg px-3 py-2">
            ...
            <input 
              type="search" 
              placeholder="Buscar..." 
              className="bg-transparent border-none focus:outline-none text-sm w-48 text-gray-700 placeholder-gray-400"
            />
          </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center space-x-3 text-gray-700 hover:text-gray-900 px-3 py-2">
            ...
            <DropdownMenuContent align="end" className="bg-white border border-gray-200 shadow-lg">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => navigate('/super_admin/configuracoes')} className="text-gray-700 hover:bg-gray-50">
