  ...
  const testAllConnections = async () => {
    ...
    try {
      ...
      if (statsError) {
        ...
        // Cast correto para o tipo esperado com verificação de tipo
        if (statsData && typeof statsData === 'object' && !Array.isArray(statsData)) {
          const stats = statsData as unknown as DashboardStats;
          setSystemStats({
            total_users: stats.total_users || 0,
            total_buildings: stats.total_buildings || 0,
            total_panels: stats.total_panels || 0,
            online_panels: stats.online_panels || 0
          });
        }
      }
    } catch (err) {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="p-3 bg-blue-50">
            ...
            <div className="text-2xl font-bold text-blue-900">{systemStats.total_users}</div>
          ...
          <Card className="p-3 bg-green-50">
            ...
            <div className="text-2xl font-bold text-green-900">{systemStats.total_buildings}</div>
          ...
          <Card className="p-3 bg-orange-50">
            ...
            <div className="text-2xl font-bold text-orange-900">{systemStats.online_panels}</div>
