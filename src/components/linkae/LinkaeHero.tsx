...
const LinkaeHero: React.FC<LinkaeHeroProps> = ({ onScrollToForm }) => {
  return (
    <section className="relative min-h-[80vh] md:min-h-[70vh] flex justify-start md:justify-center items-start md:items-center bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 text-center text-white px-6 pt-12 md:pt-0 pb-8 max-w-6xl mx-auto w-full">
        <div className="flex flex-col items-center mb-3 md:mb-6">
          <img 
            ...
            className="w-36 md:w-64 lg:w-80 h-auto mb-2 md:mb-4 animate-fade-in hover:scale-125 transition-all duration-500 drop-shadow-2xl cursor-pointer group"
        ...
        <p className="text-sm md:text-lg mb-3 md:mb-8 max-w-4xl mx-auto opacity-90 leading-relaxed">
        ...
        <button
          ...
          className="bg-gradient-to-r from-pink-500 to-orange-500 text-white font-semibold px-6 py-3 md:px-8 md:py-4 rounded-full text-base md:text-lg transition-all duration-300 hover:shadow-2xl hover:scale-105 flex items-center mx-auto space-x-2 hover:from-orange-500 hover:to-pink-500"
        >
