...
const LinkaeHero: React.FC<LinkaeHeroProps> = ({ onScrollToForm }) => {
  return (
    <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 py-8 md:py-0 max-w-6xl mx-auto">
        <div className="flex flex-col items-center mb-4 md:mb-6">
          <img 
            ...
            className="w-48 md:w-72 lg:w-96 h-auto mb-3 md:mb-4 animate-fade-in hover:scale-125 transition-all duration-500 drop-shadow-2xl cursor-pointer group"
          ...
          />
          <h1 className="text-2xl md:text-4xl font-bold text-white mb-3 mt-8 md:mt-12">
