...
const LinkaeHero: React.FC<LinkaeHeroProps> = ({ onScrollToForm }) => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-linkae-dark-blue to-linkae-royal-blue overflow-hidden">
      {/* Background Video */}
      <video 
        autoPlay 
        muted 
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
        <div className="flex flex-col items-center mb-8">
          <img 
            ...
            className="w-64 md:w-80 lg:w-96 h-auto mb-6 animate-fade-in hover:scale-125 transition-all duration-500 drop-shadow-2xl cursor-pointer group"
          ...
          />
          <h2 className="text-2xl md:text-4xl font-normal text-white/90 mb-4">
