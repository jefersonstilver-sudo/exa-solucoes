  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 px-2 md:hidden">
      <button
        ...
        className="w-full bg-gradient-to-r from-linkae-secondary to-linkae-accent text-white shadow-2xl h-16 px-8 text-lg rounded-full font-medium transition-all duration-200 flex items-center justify-center space-x-2"
      >
