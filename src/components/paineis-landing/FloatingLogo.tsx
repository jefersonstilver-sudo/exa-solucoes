...
const FloatingLogo = () => {
  ...
  return (
    <div className={`fixed top-8 right-8 md:top-12 md:right-12 z-30 transform transition-all duration-1000 ${
      ...
      <div className="relative group">
        ...
        <img
          ...
          alt="Indexa 3D Logo"
          className="w-16 h-16 md:w-20 md:h-20 object-contain animate-float filter drop-shadow-2xl opacity-60 group-hover:opacity-80 transition-opacity duration-500"
          style={{
