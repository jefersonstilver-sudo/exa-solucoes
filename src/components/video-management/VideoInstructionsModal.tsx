...
import { CheckCircle, Upload, Calendar, Tv, Loader2 } from 'lucide-react';
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-[11px] sm:text-xs">
                  Faça upload de até 4 vídeos (máx. {maxDuration} segundos, 100MB cada). Adicione títulos descritivos para fácil identificação.
                </p>
              </div>
            </div>
