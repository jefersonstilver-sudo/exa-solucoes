...
export const QRCodeDisplay = ({
  ...
  return <motion.div className="flex flex-col items-center space-y-2" initial={{
    opacity: 0,
    scale: 0.9
  }} animate={{
    opacity: 1,
    ...
    duration: 0.3
      ...
      <p className="text-sm text-gray-500 text-center">Ao confirmar o pagamento, seu pedido vai aparecer na tela de "pedidos"</p>
      
      <div className="border border-gray-200 p-4 rounded-lg bg-white">
        <img src={imageSource} alt="QR Code PIX" className="w-64 h-64" />
      </div>
    </motion.div>;
};