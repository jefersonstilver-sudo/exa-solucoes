  ...
  return (
    <Layout>
      <div className="min-h-screen bg-white sm:bg-gradient-to-br sm:from-gray-50 sm:via-gray-50 sm:to-gray-100">
        ...
        {showProgress && (
          <div className="sticky top-14 sm:top-20 z-20 bg-white shadow-sm border-b py-2 sm:py-4">
        ...
        <div className={`container mx-auto px-2 py-3 sm:px-4 sm:py-6 md:py-8 ${maxWidthClasses[maxWidth]}`}>
          {children}
        </div>
      </div>
    </Layout>
