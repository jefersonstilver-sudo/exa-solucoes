        ...
        <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 order-2 md:order-1">
              ...
              {/* Icons */}
              <div className={`flex flex-col xs:flex-row space-y-4 xs:space-y-0 xs:space-x-6 lg:space-x-8 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            ...
            {/* Visual Element */}
            <div className={`transform transition-all duration-1000 delay-500 order-1 md:order-2 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'}`}>
              <div className="relative">
                <div className="bg-gradient-to-br from-indexa-mint/20 to-indexa-purple/20 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-indexa-mint/30">
                  <div className="text-center space-y-4 sm:space-y-6">
                    ...
                    <p className="font-montserrat text-white/70 text-center leading-relaxed text-sm sm:text-base">N</p>
                  </div>
                </div>
              </div>
            </div>
