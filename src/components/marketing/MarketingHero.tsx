      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        <div className="text-center">
          <h1 className="mb-4 sm:mb-6 lg:mb-8 text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-center">
            <span className="block mb-1 sm:mb-2 text-white text-4xl">Marketing com estratégia, presença e impacto real.</span>
            <span className="block mb-1 sm:mb-2 text-white text-4xl">Campanhas completas para marcas que querem crescer.</span>
            <span className="block bg-gradient-to-r from-[#00FFAB] to-white bg-clip-text text-transparent text-2xl">
