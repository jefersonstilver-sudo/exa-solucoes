...
import { Calendar, TrendingUp, Building2, Tv, Users, Download } from 'lucide-react';
...
import { BuildingReachChart } from './BuildingReachChart';
...
export const CampaignReportCard = ({ campaign }: CampaignReportCardProps) => {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-xl rounded-2xl border border-gray-100/50 shadow-lg overflow-hidden">
      {/* Header da Campanha */}
      <div className="bg-gradient-to-r from-[#9C1E1E]/5 to-[#9C1E1E]/10 border-b border-border/40 p-6">
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Gráfico de Evolução */}
        <CampaignPerformanceChart data={campaign.chartData.weeklyExhibitions} />
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          {/* Gráfico de Alcance */}
          <BuildingReachChart data={campaign.chartData.buildingReach} />
        </div>
      </div>
    </div>
  );
