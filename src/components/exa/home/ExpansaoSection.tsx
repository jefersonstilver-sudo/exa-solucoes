    ...
    <ExaSection background="dark" id="expansao">
      ...
      >
          ...
          {timeline.map((item, index) => (
            ...
            >
              {index === 0 ? (
                ...
                <TrendingUp className="w-12 h-12 text-exa-yellow mx-auto" />
              )}
              <div className="font-montserrat font-extrabold text-6xl text-exa-yellow">
                {item.year}
              </div>
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center space-x-2 bg-exa-yellow/20 px-6 py-3 rounded-full">
            <MapPin className="w-5 h-5 text-exa-yellow" />
