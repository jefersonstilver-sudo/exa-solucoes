...
const HeroSection = () => {
  ...
  return <ExaSection background="dark" className="!py-0 min-h-[16vh] md:min-h-[18vh] flex items-start relative overflow-hidden !pt-20 md:!pt-20 pb-0 md:pb-0">
      {/* Background gradient */}
      ...
      <div ref={ref} className={`relative z-10 w-full grid lg:grid-cols-2 gap-4 md:gap-6 items-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="relative group mt-0 lg:mt-0">
