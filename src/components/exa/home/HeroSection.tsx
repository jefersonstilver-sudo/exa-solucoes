  ...
  return <ExaSection background="dark" className="min-h-[75vh] flex items-center relative overflow-hidden pt-24 md:pt-8">
      ...
      <div ref={ref} className={`relative z-10 w-full grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="relative group mt-8 lg:mt-0">
          <div className="bg-gradient-to-b from-zinc-200 to-zinc-100 p-2 md:p-2.5 lg:p-3 rounded-3xl shadow-2xl border border-white/90 max-w-[280px] md:max-w-[320px] mx-auto hover:scale-105 transition-transform duration-300">
