...
const ConfiancaSection = () => {
  ...
  return (
    <ExaSection background="dark" className="py-10 md:py-16 lg:py-24">
      <div 
        ref={ref}
      ...
      >
        <h2 className="text-xl md:text-2xl lg:text-4xl font-bold text-white font-montserrat mb-6 md:mb-12 text-center">
          ...
          {confianca.map((item, index) => {
            ...
            return (
              <ExaCard 
                key={index} 
                variant="dark" 
                className="text-center hover:scale-105 transition-transform duration-300 border-gray-800 p-4 md:p-6"
              >
                <div className="w-10 h-10 md:w-14 md:h-14 lg:w-16 lg:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-exa-yellow/10 flex items-center justify-center">
                  <IconComponent className="w-5 h-5 md:w-7 md:h-7 lg:w-8 lg:h-8 text-exa-yellow" />
                </div>
                <h3 className="text-base md:text-lg lg:text-xl font-bold text-white mb-2 md:mb-3 font-montserrat">
                  {item.title}
                </h3>
                <p className="text-xs md:text-sm lg:text-base text-gray-300 font-inter leading-relaxed">
                  {item.description}
                </p>
              </ExaCard>
            );
        ...
        <div className="mt-12">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-r from-[#9C1E1E] to-[#180A0A] flex items-center justify-center animate-pulse">
            ...
            <Link to="/midia-kit">
              <Button
                size="lg"
                className="bg-gradient-to-r from-[#9C1E1E] to-[#180A0A] hover:opacity-90 text-white font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
