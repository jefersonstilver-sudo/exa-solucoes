      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16">
          ...
          <div className="md:col-span-4">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#111111] font-montserrat">
              Nossa Essência
            </h2>
          </div>
          ...
          <div className="md:col-span-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 space-y-6 text-base md:text-lg text-[#555555] font-inter leading-[1.8]">
              <p>
