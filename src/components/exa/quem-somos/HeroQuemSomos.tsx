...
const HeroQuemSomos = () => {
  ...
  return (
    <ExaSection background="transparent" className="pt-16 md:pt-20 lg:pt-24 pb-12 md:pb-16 bg-gradient-to-br from-[#4A0E0E] via-[#6B1818] to-[#2D0808] relative overflow-hidden">
