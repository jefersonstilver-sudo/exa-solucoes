...
const FloatingCTA = ({ variant = 'default' }: FloatingCTAProps) => {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 ${sizeClasses} rounded-full bg-[#25D366] shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center group animate-fade-in`}
