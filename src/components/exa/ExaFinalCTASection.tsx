  ...
  return (
    <section className="min-h-screen bg-white flex items-center justify-center py-16 sm:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 shadow-lg">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-800 mb-8 sm:mb-12 lg:mb-16 leading-tight">
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center max-w-2xl mx-auto mb-12 sm:mb-16">
          ...
          <button className="border-2 border-slate-600 text-slate-700 font-semibold px-10 sm:px-12 py-5 sm:py-6 rounded-lg text-lg sm:text-xl lg:text-2xl transition-all duration-300 hover:bg-slate-50 w-full sm:w-auto min-h-[64px] touch-manipulation">
