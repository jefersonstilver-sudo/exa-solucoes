...
const ExaFinalCTASection: React.FC = () => {
  ...
  return (
    <section className="min-h-[60vh] bg-gradient-to-br from-slate-50 via-white to-slate-100 flex items-center justify-center py-8 sm:py-12 lg:py-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl drop-shadow-2xl border border-white/20 p-4 sm:p-6 lg:p-8 text-center" style={{boxShadow: '0 35px 60px -12px rgba(0, 0, 0, 0.4), 0 15px 35px -5px rgba(124, 58, 237, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.2)'}}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-orbitron font-black text-transparent bg-gradient-to-r from-purple-400 via-indigo-400 to-purple-600 bg-clip-text mb-6 sm:mb-8 lg:mb-10 leading-tight tracking-wide drop-shadow-2xl">
            Agende uma Reunião Gratuita
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-exo-2 font-light text-slate-700 mb-8 sm:mb-10 lg:mb-12 max-w-2xl mx-auto leading-relaxed tracking-wide">
            Descubra como a EXA pode revolucionar sua estratégia de marketing para empresários de todos os portes
          </p>
          
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center max-w-2xl mx-auto mb-8 sm:mb-10">
            <button 
