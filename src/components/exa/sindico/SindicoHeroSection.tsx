...
const SindicoHeroSection = React.memo(() => {
  ...
  return (
    <section 
      ref={ref}
      className="relative min-h-[calc(100vh-4rem)] md:min-h-[85vh] lg:min-h-[90vh] flex flex-col justify-center items-center overflow-hidden bg-gradient-to-br from-exa-black via-[#9C1E1E]/20 to-exa-black pt-24 md:pt-40 pb-28 md:pb-24"
    >
      {/* Background overlay */}
