...
const SindicoHeroSection = React.memo(() => {
  ...
  return (
    <section 
      ref={ref}
      className="relative min-h-[calc(100vh-4rem)] md:min-h-[75vh] lg:min-h-[80vh] flex flex-col justify-center items-center overflow-hidden bg-gradient-to-br from-exa-black via-[#9C1E1E]/20 to-exa-black pt-20 md:pt-16 lg:pt-14 pb-28 md:pb-22 lg:pb-20"
    >
      {/* Background overlay */}
