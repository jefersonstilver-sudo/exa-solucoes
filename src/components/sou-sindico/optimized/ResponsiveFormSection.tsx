...
const ResponsiveFormSection: React.FC<ResponsiveFormSectionProps> = memo(({ 
  isVisible, 
  formData, 
  setFormData, 
  handleSubmit, 
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-500 delay-200 ${
            ...
            <form 
              ...
              className="bg-gray-700/40 backdrop-blur-sm p-8 rounded-3xl border border-purple-400/50 shadow-2xl"
            >
              <div className="grid gap-6">
                <Input
                  ...
                  className="bg-white border-purple-400/50 text-black placeholder-gray-800 shadow-sm transition-all duration-300 focus:scale-105 focus:shadow-lg"
                  required
                />
                ...
                <Button 
                  ...
                  className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-lg py-6 rounded-xl shadow-2xl transform transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:scale-100 active:scale-95"
                >
