  ...
  const taskQuery = useQuery({
    ...
    queryFn: async (): Promise<TaskWithDetails | null> => {
      ...
      return {
        ...
        horario_inicio: (task as any).horario_inicio || null,
        ...
        tipo_evento: (task as any).tipo_evento || 'tarefa',
        subtipo_reuniao: (task as any).subtipo_reuniao || null,
        departamento_id: (task as any).departamento_id || null,
        local_evento: (task as any).local_evento || null,
        link_reuniao: (task as any).link_reuniao || null,
        escopo: (task as any).escopo || 'individual',
        task_type: taskType,
