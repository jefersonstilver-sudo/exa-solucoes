...
const LeadsLinkae = () => {
  const { leads, loading, markAsContacted } = useLeadsLinkae();
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute('download', `leads_linkae_${format(new Date(), 'yyyy-MM-dd')}.csv`);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-lg font-medium">Carregando leads LINKAÊ...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
            ...
            Leads LINKAÊ - Social Media
          </h1>
          <p className="text-gray-600 mt-2">
            Gerencie todos os leads interessados em estratégias de social media e conteúdo digital
          </p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-600 text-sm font-medium">Total de Leads</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600">
              {filter === 'all' 
                ? 'Ainda não há leads de LINKAÊ registrados no sistema.'
