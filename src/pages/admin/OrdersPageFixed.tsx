...
import { useOrdersDataFixed } from '@/hooks/useOrdersDataFixed';
import OrdersTable from '@/components/admin/orders/OrdersTable';

const OrdersPageFixed = () => {
  const { orders, stats, loading, refetch } = useOrdersDataFixed();
...
export default OrdersPageFixed;
