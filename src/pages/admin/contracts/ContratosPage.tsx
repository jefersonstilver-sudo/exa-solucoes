    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-slate-100 p-3 md:p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Gestão de contratos legais via ClickSign</p>
          </div>
        </div>
        <Button 
          onClick={() => navigate(buildPath('contratos/novo'))}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        ...
        <Card className="p-4 bg-white/80 backdrop-blur-sm border border-white/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">Taxa Assinatura</p>
      ...
      {isLoading ? (
        ...
        <Card className="p-12 text-center bg-white/80 backdrop-blur-sm">
          ...
          <Button onClick={() => navigate(buildPath('contratos/novo'))}>
            <Plus className="h-4 w-4 mr-2" />
            Criar Contrato
          </Button>
        </Card>
          ...
          {filteredContratos.map((contrato) => {
            ...
            return (
              <Card 
                ...
                onClick={() => navigate(buildPath(`contratos/${contrato.id}`))}
              >
                  ...
                  <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => navigate(buildPath(`contratos/${contrato.id}`))}>
