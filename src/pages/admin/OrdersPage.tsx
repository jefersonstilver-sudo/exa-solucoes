    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-center py-12">
          ...
          <span className="ml-2 text-black">Carregando pedidos...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-black">Gerenciar Pedidos</h1>
          <p className="text-gray-600">Sistema completo de pedidos com dados sincronizados</p>
        </div>
        <div className="flex items-center space-x-3">
          ...
          <Button className="bg-[#00FFAB] hover:bg-[#00FFAB]/80 text-white font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
        ...
        <Card className="bg-gradient-to-br from-orange-100 to-orange-50 border-orange-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Aguard. Vídeo</CardTitle>
            <Clock className="h-4 w-4 text-orange-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-black">{stats.awaiting_video}</div>
        ...
        <Card className="bg-gradient-to-br from-blue-100 to-blue-50 border-blue-200">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Vídeo Enviado</CardTitle>
            <Video className="h-4 w-4 text-blue-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-black">{stats.video_sent}</div>
            <p className="text-xs text-blue-500">para análise</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-green-100 to-green-50 border-green-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">{stats.video_approved}</div>
        ...
        <Card className="bg-gradient-to-br from-red-100 to-red-50 border-red-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">{stats.video_rejected}</div>
          ...
          <div className="flex gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-white border-gray-200">
                <DropdownMenuItem onClick={() => setStatusFilter('all')} className="text-black hover:bg-gray-100">
                  Todos
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setStatusFilter('pago_pendente_video')} className="text-black hover:bg-gray-100">
                  Aguardando Vídeo
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setStatusFilter('video_enviado')} className="text-black hover:bg-gray-100">
                  Vídeo Enviado
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setStatusFilter('video_aprovado')} className="text-black hover:bg-gray-100">
                  Vídeo Aprovado
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setStatusFilter('video_rejeitado')} className="text-black hover:bg-gray-100">
                  Vídeo Rejeitado
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setStatusFilter('ativo')} className="text-black hover:bg-gray-100">
                  Ativos
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setStatusFilter('pendente')} className="text-black hover:bg-gray-100">
                  Pendentes
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => setStatusFilter('cancelado')} className="text-black hover:bg-gray-100">
                  Cancelados
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
      ...
      <Card className="bg-white border-gray-200">
        <CardHeader>
          <CardTitle className="text-black">Lista de Pedidos</CardTitle>
