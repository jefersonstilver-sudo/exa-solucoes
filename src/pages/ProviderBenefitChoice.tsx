...
const ProviderBenefitChoice = () => {
        ...
        <Card className="max-w-2xl w-full">
          <CardContent className="flex flex-col items-center text-center py-12 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-2xl font-bold text-primary">{selectedBenefit?.name}</p>
            </div>
            <div className="bg-muted p-6 rounded-lg max-w-md">
              <p className="text-sm text-muted-foreground">
                Em breve você receberá um email com o código do seu vale-presente de <strong className="text-primary">R$ 50,00</strong>.
              </p>
  ...
  // Choosing state
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-purple-600 to-pink-500 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="inline-block bg-white rounded-2xl px-8 py-6 shadow-2xl mb-6">
            <h1 className="text-4xl font-black text-primary mb-2">EXA MÍDIA</h1>
            ...
            <CardContent className="py-8">
              ...
              <div className="mt-6 p-4 bg-primary/10 rounded-lg">
                <p className="text-lg">
                  ...
                  <strong className="text-2xl text-primary">R$ 50,00</strong>
                </p>
              </div>
            </CardContent>
          </Card>
