...
const ProfileSettings = () => {
  ...
  const { sendReset: handlePasswordResetRequest, isLoading: sendingPasswordReset, cooldown: resetCooldown } = usePasswordReset(user?.email, {
    onSuccess: () => {
  ...
  // handlePasswordResetRequest is provided by usePasswordReset hook above
