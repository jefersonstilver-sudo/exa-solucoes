...
const AdvertiserDashboard = () => {
  ...
  // Dados para gráficos
  const chartData = [
    { name: 'Jan', value: stats.valorTotalGasto * 0.1 },
    { name: 'Fev', value: stats.valorTotalGasto * 0.2 },
    { name: 'Mar', value: stats.valorTotalGasto * 0.3 },
    { name: 'Abr', value: stats.valorTotalGasto * 0.5 },
    { name: 'Mai', value: stats.valorTotalGasto },
  ];

  const pieData = [
    { name: 'Pagos', value: stats.pedidosPagos, color: '#10B981' },
    { name: 'Pendentes', value: stats.pedidosPendentes, color: '#F59E0B' },
  ];
