...
const MOCK_DIRECTORS = [
  { id: '1', nome: 'Jefferson Silver' },
  { id: '2', nome: 'Maria Santos' },
  { id: '3', nome: 'Carlos Admin' },
];
...
export const ConfigAlertModal = ({ open, onOpenChange, alertTitle }: ConfigAlertModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[650px] max-h-[90vh] overflow-y-auto bg-white/95 dark:bg-gray-950/95 backdrop-blur-2xl border-2">
        <DialogHeader>
          ...
          >
            ...
            <div className="space-y-3">
              {MOCK_DIRECTORS.map((director) => (
                <div
                  key={director.id}
                  className="flex items-center gap-3 p-3 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-purple-300 dark:hover:border-purple-700 transition-colors"
                >
                  <Checkbox
