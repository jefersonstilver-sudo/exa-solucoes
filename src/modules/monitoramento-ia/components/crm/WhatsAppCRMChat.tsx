...
export const WhatsAppCRMChat: React.FC<WhatsAppCRMChatProps> = ({ conversationId, messages, loading, onRefresh, isFullscreen = false, onToggleFullscreen }) => {
  ...
  return (
    <div className="flex h-full">
      {/* Área de mensagens - Fundo elegante gradiente escuro */}
      <div className="flex-1 flex flex-col bg-gradient-to-br from-slate-100 via-slate-50 to-gray-100 dark:from-neutral-900 dark:via-neutral-850 dark:to-neutral-900 relative">
        {/* Pattern sutil elegante (estilo WhatsApp) */}
        <div 
