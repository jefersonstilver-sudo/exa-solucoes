...
export const Agentes = () => {
  ...
  return <div className="min-h-screen bg-module-primary p-4 lg:p-6 space-y-4 lg:space-y-6 max-w-[1600px] mx-auto">
      {/* HEADER - Apple-like Mobile-First */}
      <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-2xl p-4 sm:p-6 shadow-[var(--shadow-glass)]">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[hsl(var(--apple-gray-900))] flex items-center gap-2 sm:gap-3 tracking-tight">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-[#9C1E1E] to-[#7A1616] flex items-center justify-center shadow-lg shadow-[#9C1E1E]/20 flex-shrink-0">
                <Bot className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
              </div>
              <span className="truncate">Agentes Inteligentes</span>
            </h1>
            <p className="text-sm sm:text-base text-[hsl(var(--apple-gray-500))] mt-1 sm:mt-2">
          ...
          <Button 
            ...
            className="bg-[hsl(var(--exa-red))] hover:bg-[hsl(var(--exa-red-dark))] text-white w-full sm:w-auto min-h-[44px] shadow-md"
          >
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="mb-4 sm:mb-6 relative">
          ...
          <div className="overflow-x-auto scrollbar-hide pb-2 -mx-4 px-4 sm:mx-0 sm:px-0">
            <TabsList className="bg-white/90 backdrop-blur-xl border border-white/40 inline-flex min-w-max gap-1 sm:gap-2 p-1 rounded-full shadow-sm">
              <TabsTrigger 
                value="overview" 
